...
const DocumentCard = ({ document, onDelete }) => {
    ...
    return (
        ...
        >
            ...
            {/* Hover overlay */}
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 to-teal-500 group-hover:from-emerald-500/5 group-hover:to-teal-500/5 transition-all duration-300 pointer-events-none" />
        </div>
    );
};
