...
import { CheckCircle2, XCircle, Trophy, Target, BookOpen, ArrowLeft } from 'lucide-react';

const QuizResultPage = () => {
    
    const { quizId } = useParams(); // Fixed capitalization
    const [results, setResults] = useState(null);
    const [loading, setLoading] = useState(true);
    
    useEffect(() => { // Fixed braces to parentheses
        ...
        fetchResults();
    }, [quizId]); // Fixed bracket structure
    ...
    return ( 
    <div className="max-w-5xl mx-auto pb-20"> {/* Wrapped in one div */}
        {/*Back button */}
        <div className="mb-6">
            <Link
        ...
        {/*Score Card */}
        <div className="bg-white border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8">
            ...
            <div className="flex items-center justify-center gap-4 pt-8">
                <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl">
                    <Target className="w-4 h-4 text-slate-700" strokeWidth={2} />
        ...
        <div className="space-y-6">
            ...
            {detailedResults.map((result, index) => {
                ...
                return (
                    <div 
                        key={index}
                        className="bg-white border-2 border-slate-200 rounded-2xl p-6 shadow-lg shadow-slate-200/50 space-y-4"
                    >
                        ...
                        <div className="space-y-3">
                            {result.options.map((option, optIndex) => { // Fixed mapping arguments
                        ...
                        {result.explanation && (
                            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl mt-4">
                                <div className="flex items-start gap-3">
                                    <div className="shrink-0 w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center mt-0.5">
